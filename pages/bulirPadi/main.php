        ...
        <div class="col-lg-8 col-md-4 col-sm-12">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                <div class="card-header">
                  <h4>Kriteria Bulir Padi (C2)</h4>
                  <div class="card-header-action">
                    <a href="form_tambah.php" class="btn btn-danger">Tambah Bulir  Padi <i class="fas fa-chevron-right"></i></a>
                  </div>
                </div>
                <div class="card-body p-0">
                  <div class="table-responsive table-invoice">
                    <table class="table table-striped">
                      <tr>
                        <th>  ID</th>
                        <th>Jenis Bulir Padi</th>
                        <th>Bobot</th>
                        <th>Nilai</th>
                        <th>Action</th>
                      </tr>
                      <?php
                            $sql = "SELECT * FROM tb_bobotnilai b , tb_bulirpadi j WHERE b.id_bobotnilai = j.id_bobotnilai ORDER BY id_bulirPadi";
                       ...
                       while($data = mysqli_fetch_array($q)){
                        ...
                        ?>
                      <tr>
                        <td><?php echo $data['id_bulirPadi']; ?></td>
                        <td class="font-weight-600"><?php echo $data['NamaBulir']; ?></td>
                        
                        <td><div class="badge badge-warning"><?php echo $data['Bobot']; ?></td>
                        <td><div class="badge badge-warning"><?php echo $data['nilai_bulirpadi']; ?></div></td>
                        <td>
                          <a href="form_edit.php?id_bulirPadi=<?= $data['id_bulirPadi']; ?>" class="btn btn-primary">Edit</a>
                          <a href="<?php echo $baseUrl; ?>pages/bulirPadi/hapus.php?id_bulirPadi=<?php echo $data['id_bulirPadi']; ?>" onclick="return confirm('Yakin Ingin menghaous')"" class="btn btn-danger">Hapus</a>
                        </td>
                      </tr>
                      <?php
                       }
