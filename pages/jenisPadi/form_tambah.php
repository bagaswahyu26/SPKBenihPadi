                  ...
                  <form action="simpan.php" method="POST">
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="" name="JenisPadi">
                      </div>
                      <div class="form-group">
                      <label>Bobot</label>
                    ...
                    <div class="form-group">
                        <label>Nilai</label>
                        <input type="text" class="form-control" required="" name="nilai_jenispadi">
                      </div>
                    </div>
